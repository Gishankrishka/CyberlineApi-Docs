...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900">
      ...
      <div className="fixed inset-0 bg-[linear-gradient(rgba(239,68,68,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(239,68,68,0.03)_1px,transparent_1px)] bg-[size:50px_50px] pointer-events-none"></div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 py-6 sm:py-8 relative">
          ...
          {filteredEndpoints.length === 0 ? (
            ...
            <div className="space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                {error && (
                  <div className="text-red-300 text-xs sm:text-sm bg-red-900/20 border border-red-700/50 px-3 py-2 rounded-lg">
      ...
      <footer className="bg-black/60 backdrop-blur-sm border-t border-gray-800/50 text-gray-400 py-6 sm:py-8 mt-12 sm:mt-16 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          <div className="mr-4 sm:mr-6 lg:mr-8">
            <div className="flex flex-col items-center space-y-4">
              ...
              <div className="pt-4 border-t border-gray-800/50 text-center w-full">
